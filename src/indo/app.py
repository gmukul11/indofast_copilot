...
if __name__ == "__main__":
    ...
    # Main header
    st.markdown('<h1 style="font-size: 2.5rem; font-weight: bold; color: #ffffff; text-align: center; margin-bottom: 1rem;">🔋 IndoFast AI Copilot</h1>', unsafe_allow_html=True)
